        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href={ "https://github.com/lavya30"} className="text-slate-500 hover:text-white transition-colors">
              ...
              <Link href={ "https://www.linkedin.com/in/lavya-goel-173a26295 "} className="text-slate-500 hover:text-white transition-colors">
